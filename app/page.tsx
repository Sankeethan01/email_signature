    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-500 to-purple-600 text-white">
      ...
      <section className="flex flex-col items-center justify-center py-32 text-center">
        <h1 className="text-5xl md:text-6xl font-extrabold mb-6">
          ...
          <span className="text-yellow-300">Email Signature</span>
        </h1>
        <p className="text-xl md:text-2xl max-w-3xl mb-8">
          Stand out with a unique, personalized signature. Choose from 50+
          templates and customize in minutes—all for free!
        </p>
        <Link href="/templates">
      ...
      <section className="bg-white text-gray-800 py-20 px-6 md:px-12">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-bold mb-8">
            Why Choose Simple Email Signature?
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                title: "Easy to Use",
                desc: "No coding required, just fill in your details.",
                icon: <FaCheckCircle className="text-blue-500 text-4xl" />,
              },
              {
                title: "Professional Designs",
                desc: "Choose from 50+ modern templates.",
                icon: <FaCheckCircle className="text-green-500 text-4xl" />,
              },
              {
                title: "100% Free",
                desc: "No sign-ups or hidden fees!",
      ...
      {/* Add Some Gap Above Navbar */}
      <div className="bg-white text-gray-800 h-24"></div>
